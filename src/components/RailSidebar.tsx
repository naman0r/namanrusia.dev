...
// Left padding pages use on desktop to clear the fixed 88px rail. The rail
// expands as an overlay so this never changes.
export const CONTENT_PADDING = "lg:pl-[108px]";
